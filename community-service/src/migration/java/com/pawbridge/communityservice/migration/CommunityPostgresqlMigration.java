...
public final class CommunityPostgresqlMigration {
    ...
    private CommunityPostgresqlMigration() { }
    ...
    static final class Settings {
        ...
        static Settings from(Map<String, String> env) {
            String url = required(env, "COMMUNITY_PG_MIGRATION_JDBC_URL");
            ...
            return new Settings(url, required(env, "COMMUNITY_PG_MIGRATION_USERNAME"),
                    required(env, "COMMUNITY_PG_MIGRATION_PASSWORD"),
                    url.equals(env.get("COMMUNITY_PG_MIGRATION_CONFIRM_TARGET")));
        }
