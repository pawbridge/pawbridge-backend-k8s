        ...
        try {
            ...
            try (var factory = metadata.buildMetadata().buildSessionFactory()) {
                ...
                try (org.hibernate.Session session = factory.openSession()) {
                    ...
                    session.persist(com.pawbridge.paymentservice.common.entity.Outbox.builder().aggregateType("TEST").aggregateId("1").eventType("TEST_CREATED").payload(payload).build());
