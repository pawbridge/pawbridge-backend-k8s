...
public final class PaymentPostgresqlMigration {
    ...
    private PaymentPostgresqlMigration() { }
    ...
    static final class Settings {
        ...
        static Settings from(Map<String, String> env) {
            String url = required(env, "PAYMENT_PG_MIGRATION_JDBC_URL");
            ...
            return new Settings(url, required(env, "PAYMENT_PG_MIGRATION_USERNAME"),
                    required(env, "PAYMENT_PG_MIGRATION_PASSWORD"),
                    url.equals(env.get("PAYMENT_PG_MIGRATION_CONFIRM_TARGET")));
        }
