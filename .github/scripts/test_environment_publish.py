...
CASES = [('api-gateway-ci.yml', 'api-gateway', 'chore/api-gateway-image-'), ('store-service-ci.yml', 'store-service', 'chore/store-image-'), ('_java-service-image.yml', 'animal-service', 'chore/animal-service-image-')]
