...
public final class AnimalPostgresqlMigration {
    ...
    private AnimalPostgresqlMigration() { }
    ...
    static final class Settings {
        ...
        static Settings from(Map<String, String> env) {
            String url = required(env, "ANIMAL_PG_MIGRATION_JDBC_URL");
            ...
            return new Settings(url, required(env, "ANIMAL_PG_MIGRATION_USERNAME"),
                    required(env, "ANIMAL_PG_MIGRATION_PASSWORD"),
                    url.equals(env.get("ANIMAL_PG_MIGRATION_CONFIRM_TARGET")));
        }
