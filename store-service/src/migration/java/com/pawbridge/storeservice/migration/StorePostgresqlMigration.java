...
public final class StorePostgresqlMigration {
    ...
    private StorePostgresqlMigration() { }
    ...
    static final class Settings {
        ...
        static Settings from(Map<String, String> env) {
            String url = required(env, "STORE_PG_MIGRATION_JDBC_URL");
            ...
            return new Settings(url, required(env, "STORE_PG_MIGRATION_USERNAME"),
                    required(env, "STORE_PG_MIGRATION_PASSWORD"),
                    url.equals(env.get("STORE_PG_MIGRATION_CONFIRM_TARGET")));
        }
